    ...
    <div className='w-screen h-screen px-12 pt-8 pb-12 bg-black'>
      <div className='lg:w-[40%] h-3/4 md:h-full flex flex-col justify-center'>
        ...
        <form onSubmit={handleLogin}>
          ...
          <button type="submit" className="btn-primary text-black bg-green-600 mt-2 p-1 rounded-sm">LOGIN</button>
          <p className="text-[14px] text-green-500 mt-3">Don't have an account?{""}<Link className="font-medium text-primary underline" to="/signup">SignUp</Link></p>
        </form>
      </div>
    </div>
  )
